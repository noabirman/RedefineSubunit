...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Put phospho site inside MSA output files.")
    parser.add_argument("msa_output_root", help="Path to the MSA output root directory")
    parser.add_argument("phospho_file", help="Path to the relevant phospho JSON file")
    args = parser.parse_args()

    main(args.msa_output_root, args.phospho_file)